...
std::shared_ptr<AnimatedBackground> ResourceManager::createAnimatedBackground(const std::string& animatedBackgroundName, 
																			  const std::string& backgroundName, 
																			  const std::string& cloud1Name, 
																			  const std::string& cloud2Name,
																			  const std::string& crown1Name, 
																			  const std::string& crown2Name,
																			  const std::string& crown3Name,
																			  const std::string& crown4Name,
																			  const std::string& crown5Name,
																			  const std::string& shoreName) {
	return animatedBackgroundMap.emplace(animatedBackgroundName, std::make_shared<AnimatedBackground>(getBackground(backgroundName), 
																									  getSprite(cloud1Name), 
																									  getSprite(cloud2Name),
																									  getSprite(crown1Name),
																									  getSprite(crown2Name),
																									  getSprite(crown3Name),
																									  getSprite(crown4Name),
																									  getSprite(crown5Name),
																									  getSprite(shoreName))).first->second;
}
...
std::shared_ptr<AnimatedBackground> ResourceManager::createAnimatedBackground(const std::string& animatedBackgroundName, 
	...
	return animatedBackgroundMap.emplace(animatedBackgroundName, std::make_shared<AnimatedBackground>(background, 
																									  cloud1,
																									  cloud2,
																									  crown1,
																									  crown2,
